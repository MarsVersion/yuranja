export function AboutPage() {
  return (
    <main className="mx-auto max-w-[1440px] px-6 py-16 md:px-20 md:py-24">
      <h1 className="font-display text-5xl md:text-7xl">About Yuranja</h1>
      ...
      <section id="editorial" className="mt-24 max-w-3xl scroll-mt-28 border-t border-line pt-16">
        <h2 className="font-display text-3xl md:text-4xl">Editorial guide</h2>
        <p className="mt-6 font-body text-base font-light leading-relaxed text-muted">
