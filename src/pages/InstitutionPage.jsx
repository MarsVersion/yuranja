  ...
  if (!i) {
    return (
      <main className="mx-auto max-w-[720px] px-6 py-24 text-center">
        ...
        <Link
          to="/cities"
          className="mt-8 inline-block border border-ink px-8 py-4 font-sans text-caption font-semibold uppercase tracking-[0.2em] hover:bg-ink hover:text-canvas"
        >
          Back to cities
        </Link>
      </main>
        ...
        <div className="absolute inset-x-0 bottom-0 p-6 md:p-20">
          <div className="mx-auto flex max-w-[1440px] flex-col gap-4 text-white">
            <div className="flex flex-wrap items-center gap-3">
              <span className="rounded-full bg-white/15 px-3 py-1 font-sans text-micro font-semibold uppercase tracking-[0.2em] backdrop-blur">
                {i.type}
              </span>
        ...
        <div className="grid grid-cols-1 items-start gap-12 md:grid-cols-12 md:gap-8">
          ...
          <div className="md:col-span-4 md:col-start-9">
            <div className="border-l border-ink pl-8">
              ...
              <p className="mt-2 whitespace-pre-line font-sans text-sm leading-relaxed">{i.address}</p>
              <a
                href={i.website}
                className="mt-4 inline-block font-sans text-caption font-semibold uppercase tracking-[0.2em] text-accent-green underline-offset-4 hover:underline"
                target="_blank"
                rel="noreferrer"
              >
                Website
              ...
              <div className="mt-8">
                ...
                <p className="mt-2 whitespace-pre-line font-sans text-sm leading-relaxed">{i.hours}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-[1440px] px-6 md:px-20">
          <div className="mb-12 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <h2 className="mt-4 font-serif text-3xl md:text-4xl">Visitor information</h2>
            </div>
          </div>
          ...
          <div className="mt-8 grid gap-6 border border-line bg-canvas p-8 md:grid-cols-2">
            <div>
              ...
              <p className="mt-2 font-sans text-sm">{i.audioGuide}</p>
            </div>
            <div>
        ...
        <div className="mx-auto max-w-[1440px] px-6 text-center md:px-20">
          ...
          <div className="mt-16 grid gap-12 text-center md:grid-cols-3 md:gap-8">
            <div>
              ...
              <h3 className="mt-4 font-serif text-2xl">Neighborhood map</h3>
            ...
            <div>
              ...
              <h3 className="mt-4 font-serif text-2xl">Late hours &amp; quiet slots</h3>
              <p className="mt-3 font-sans text-sm text-white/60">
                We flag evenings and weekday mornings when the building breathes.
              </p>
              <span className="mt-6 inline-block font-sans text-caption font-semibold uppercase tracking-[0.25em] text-white/50">
                Detailed in the listing above
              </span>
            </div>
            <div>
              <span className="material-symbols-outlined text-4xl text-white/90">search</span>
              <h3 className="mt-4 font-serif text-2xl">Related spaces</h3>
              <p className="mt-3 font-sans text-sm text-white/60">
