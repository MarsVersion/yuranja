          ...
          {picks.length > 0 ? (
            <ul className="mt-12 grid gap-10 md:grid-cols-2 lg:grid-cols-3">
              {picks.map((space) => (
                <li key={space.slug}>
                  ...
                  >
                    <span className="font-sans text-micro font-semibold uppercase tracking-[0.2em] text-accent-green">
                      {space.type}
                    </span>
                    ...
                    <span className="mt-8 inline-flex items-center gap-2 font-sans text-caption font-semibold uppercase tracking-[0.2em] text-ink">
                      Read the listing
            ...
            <div className="mt-12 max-w-2xl border border-line bg-surface-muted/25 px-10 py-12">
              ...
              <div className="mt-10 flex flex-wrap gap-4">
                <Link
                  to="/exhibitions"
                  className="border border-ink bg-ink px-6 py-3 font-sans text-caption font-semibold uppercase tracking-[0.2em] text-canvas transition-colors hover:bg-canvas hover:text-ink"
                >
                  Exhibitions
                </Link>
                <Link
